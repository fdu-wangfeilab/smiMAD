...
def construct_neighbor_graph(adata_omics1, adata_omics2, use_pca=True, adata_omics2_type='ADT', spatial_neighbors=3,
    ...
    #feature
    adata_omics1 = construct_adjacency_by_features(adata_omics1, n_neighbors=omics1_neighbors, use_pca=use_pca, n_comps=omics1_comps)
    adata_omics2 = construct_adjacency_by_features(adata_omics2, n_neighbors=omics2_neighbors, use_pca=use_pca,
...
def construct_adjacency_by_features(adata, n_neighbors=2, use_pca=True, n_comps=50, Mtype='RNA'):
    if use_pca:
...
def pre_process(adata1_path,adata2_path,data_type='Simulation',spatial_neighbors=20,omics1_neighbors=10,omics2_neighbors=10,radius=0.1):
    adata_omics1 = sc.read_h5ad(adata1_path)
    adata_omics2 = sc.read_h5ad(adata2_path)
    
    adata_omics1.var_names_make_unique()
    adata_omics2.var_names_make_unique()
    
    if data_type == 'Simulation' or data_type == 'spatial‐CITE‐seq' or data_type == 'Stereo-CITE-seq':
        ...
        adata_omics1, adata_omics2 = construct_neighbor_graph(
            ...
            omics1_neighbors=omics1_neighbors,
            omics2_neighbors=omics2_neighbors,
            radius=radius,
        )
        

    elif data_type == 'MISAR-seq':
        sc.pp.highly_variable_genes(adata_omics1, flavor="seurat_v3", n_top_genes=3000)
    ...
    elif data_type == 'SPOTS' or data_type == 'DBiT‑seq':
        # RNA
